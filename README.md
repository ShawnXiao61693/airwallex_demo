...
- **解题思路 + 完成度**：https://airwallex.clawn.dev/airwallex/solution.html
- **用户端（销售视角）**：https://airwallex.clawn.dev/airwallex/app.html　——　用 **Alex（AE）/ Cindy（AM）** 两个身份分别进，对比看到的不同
- **RevE 工作台（管理端）**：https://airwallex.clawn.dev/airwallex/admin.html　——　看「日报审核」：AI 每天出 3 个候选，人选 1 版发布
...
- 真实样例直接进系统看：日报 https://airwallex.clawn.dev/airwallex/app.html ；RevE 工作台 https://airwallex.clawn.dev/airwallex/admin.html
